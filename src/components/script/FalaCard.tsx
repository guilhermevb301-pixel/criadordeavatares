...
import { Copy, Check, RefreshCw, Sparkles, ArrowDown, ArrowUp, MessageCircle, Zap } from 'lucide-react';
    ...
    <Card className="border-border/50 shadow-card hover:shadow-card-hover transition-all duration-300 overflow-hidden group">
      <CardContent className="p-5 space-y-4">
        ...
        <div className="grid grid-cols-2 gap-2 text-xs text-muted-foreground">
          <div>🎭 <span className="font-medium">{fala.expressao}</span></div>
          <div>💡 <span className="font-medium">{fala.intencao}</span></div>
