...
import { UserCircle, FileText, Video, Settings, Sparkles } from 'lucide-react';
...
const cards = [
  ...
  {
    title: 'Gerar Roteiros UGC',
    description: 'Crie scripts persuasivos para vídeos de conteúdo gerado por usuários',
    icon: FileText,
    path: '/roteiros',
  },
  {
    ...
    <div className="flex flex-1 flex-col items-center justify-center p-6 md:p-10">
      ...
      <div className="grid w-full max-w-3xl grid-cols-1 gap-6 sm:grid-cols-2">
        {cards.map((card) => (
          ...
          >
            <div className="flex h-16 w-16 items-center justify-center rounded-full bg-secondary transition-colors duration-300 group-hover:bg-accent group-hover:text-accent-foreground group-disabled:group-hover:bg-secondary">
